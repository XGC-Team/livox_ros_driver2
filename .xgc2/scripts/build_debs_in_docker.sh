...
docker run --rm \
  ...
  bash -lc '
    ...
    mkdir -p /workspace/work/src/livox_ros_driver2
    rsync -a --delete /workspace/repo/ /workspace/work/src/livox_ros_driver2/
    cp /workspace/work/src/livox_ros_driver2/package_ROS1.xml /workspace/work/src/livox_ros_driver2/package.xml
